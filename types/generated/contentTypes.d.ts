...
export interface ApiEditHistoryEditHistory extends Schema.CollectionType {
  collectionName: 'edit_histories';
  info: {
    description: 'Audit log for tracking shipment edits and deletions';
    displayName: 'Edit History';
    pluralName: 'edit-histories';
    singularName: 'edit-history';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    action: Attribute.Enumeration<['UPDATE', 'DELETE']> & Attribute.Required;
    changes: Attribute.JSON;
    createdAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::edit-history.edit-history',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiShipmentShipment extends Schema.CollectionType {
  ...
  attributes: {
    coal_type: Attribute.Enumeration<['CRUSHED', 'UNCRUSHED']>;
    createdAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::shipment.shipment',
      'oneToOne',
    ...
    date: Attribute.Date;
    date_shift: Attribute.Date;
    dumping: Attribute.String;
    finish: Attribute.Relation<
      'api::shipment.shipment',
      'oneToOne',
      'api::finish.finish'
    >;
...
export interface ApiSummarySummary extends Schema.CollectionType {
  ...
  attributes: {
    avg_duration: Attribute.Float;
    coal_type: Attribute.Enumeration<['CRUSHED', 'UNCRUSHED', 'ALL']>;
    createdAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::summary.summary',
      'oneToOne',
    ...
    publishedAt: Attribute.DateTime;
    shift: Attribute.String;
    total_finish: Attribute.Integer;
    total_intransit: Attribute.Integer;
    total_net_weight: Attribute.Float;
    total_shipment: Attribute.Integer;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
      'api::summary.summary',
      'oneToOne',
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::edit-history.edit-history': ApiEditHistoryEditHistory;
